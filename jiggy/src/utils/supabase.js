...
const supabaseUrl = importMetaEnv?.VITE_SUPABASE_URL || process.env.REACT_APP_SUPABASE_URL || "";
const supabaseKey = importMetaEnv?.VITE_SUPABASE_KEY || process.env.REACT_APP_SUPABASE_KEY || "";
